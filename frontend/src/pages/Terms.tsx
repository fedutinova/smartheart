      ...
      <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6">
        ...
        <div className="prose prose-sm prose-gray max-w-none space-y-6 text-gray-700">
          ...
          <section>
            ...
            <p>
              Исполнитель предоставляет Пользователю доступ к Сервису для автоматизированного
              анализа изображений электрокардиограмм (ЭКГ) с использованием технологий
              искусственного интеллекта, а также доступ к базе знаний по кардиологии.
            </p>
          </section>
