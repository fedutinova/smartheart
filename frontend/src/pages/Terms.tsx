        ...
        <div className="prose prose-sm prose-gray max-w-none space-y-6 text-gray-700">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li>Сервис предоставляет 3 (три) бесплатных анализа ЭКГ всего</li>
              <li>Для неограниченного количества анализов требуется месячная подписка</li>
              ...
              <li>Активная подписка не имеет срока давности до истечения периода</li>
            </ul>
          </section>
